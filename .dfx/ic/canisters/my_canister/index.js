...
export { idlFactory } from './my_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MY_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_canister.did.js")._SERVICE>}
 */
export const my_canister = createActor(canisterId);
